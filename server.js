...
app.patch('/api/orders/:id/status', (req, res) => {
  ...
  if (!order.value()) return res.status(404).json({ success: false, message: 'Order not found.' });
...
app.get('/api/stats', (req, res) => {
  ...
  const stats = {
    ...
    total_kg: orders.filter(o => o.order_status !== 'Cancelled').reduce((sum, o) => sum + o.quantity, 0)
  };
